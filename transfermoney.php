...
<div class="main_div">
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:76px;background-color:black;border-radius:10px;color:white" >
              <form method="POST">  
...
?> 
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:60px;height:380px;">
                   <div class="card-body">
                   <img src="money.jpg" style="width:250px;height:220px;margin-top:40px;">
